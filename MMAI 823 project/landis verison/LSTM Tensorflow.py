...
data = quandl.get_table('WIKI/PRICES', qopts = { 'columns': ['ticker', 'date', 'adj_close','adj_open','adj_low','adj_volume'] }, ticker = ['AAPL'], date = { 'gte': '2009-01-01', 'lte': '2019-12-19' })
...
train_data = close[:1956]
test_data = close[1956:]###365
...
dg = DataGeneratorSeq(train_data, 30, 5)
...
test_points_seq = np.arange(1957,len(data)-51, 30).tolist()
